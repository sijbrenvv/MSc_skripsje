...
python3 create_splits_authsyn.py -ad $auth_data -sd $syn_data -out "${exp_fol}/out/" #> ${log}splits
...
# Backup scripts
cp smp_clf/smp_clf_train.py smp_clf/smp_clf_predict.py smp_clf/smp_clf_evaluate.py rule_base.py create_splits_authsyn.py $bkp